	...
	CommandLineRunner iniOrdenador(OrdenadoresRepo repoOedenador) {
		...
		return (arg)-> {
			...
			repoOedenador.saveAll(Arrays.asList(
					...
					new Ordenador("MasterGold", serviceRam.buscarRam((long)1), serviceProcesador.buscarProcesador((long)2), serviceDisco.buscarDisco((long) 2), serviceGrafica.buscarGrafica((long)2), serviceFuente.buscarFuente((long)2), enlace4, "Descripción basica", "Pc con tales características preparado para usar en x sectores" , 3, 842),
					...
					new Ordenador("MasterDiamante", serviceRam.buscarRam((long)2), serviceProcesador.buscarProcesador((long)2), serviceDisco.buscarDisco((long) 2), serviceGrafica.buscarGrafica((long)2), serviceFuente.buscarFuente((long)2), enlace4, "Descripción basica", "Pc con tales características preparado para usar en x sectores" , 3, 343.90),
					...
					new Ordenador("Master mx2", serviceRam.buscarRam((long)1), serviceProcesador.buscarProcesador((long)2), serviceDisco.buscarDisco((long) 2), serviceGrafica.buscarGrafica((long)2), serviceFuente.buscarFuente((long)2), enlace1, "Descripción basica", "Pc con tales características preparado para usar en x sectores" , 3, 220),
					...
					new Ordenador("HP 290 G4", serviceRam.buscarRam((long)4), serviceProcesador.buscarProcesador((long)2), serviceDisco.buscarDisco((long) 2), serviceGrafica.buscarGrafica((long)2), serviceFuente.buscarFuente((long)2), enlace1, "Descripción basica", "Pc con tales características preparado para usar en x sectores" , 3, 100),
